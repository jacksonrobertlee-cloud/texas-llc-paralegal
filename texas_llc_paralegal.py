...
def pdf_operating_agreement(d: dict) -> BytesIO:
    ...
    story.append(Paragraph("ARTICLE VII — BOOKS, RECORDS, AND ACCOUNTING", styles["Rob_Head"]))

    story.append(Paragraph("<b>7.1 Books and Records.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>7.2 Fiscal Year.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>7.3 Tax Treatment.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>7.4 Bank Accounts.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("ARTICLE VIII — DISSOLUTION AND WINDING UP", styles["Rob_Head"]))

    story.append(Paragraph("<b>8.1 Events of Dissolution.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>8.2 Winding Up.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>8.3 Certificate of Termination.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("ARTICLE IX — MISCELLANEOUS", styles["Rob_Head"]))

    story.append(Paragraph("<b>9.1 Indemnification.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>9.2 Entire Agreement.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>9.3 Amendment.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>9.4 Severability.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>9.5 Counterparts.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>9.6 Notices.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
    ...
    story.append(Paragraph("<b>9.7 Waiver.</b>", styles["Rob_Body"]))
    story.append(Paragraph(
